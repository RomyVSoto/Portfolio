...
export default function Home() {
  return (
    <div className="flex flex-col gap-12 sm:gap-14 md:gap-20 pt-10">
      ...
      {/* About */}
      <section id="projects" className="flex items-center justify-between gap-14 py-1 px-5">
        <div className="w-full flex flex-col gap-6">
          ...
          <span className="font-sans font-normal text-lg text-text-secondary max-w-xl ">
            ...
            design. 
            <br /><br />
            I work primarily in the React and Next.js ecosystem, lean on
            TypeScript for safety, and care a lot about details: motion that
            feels right, type that reads well, and APIs that don&apos;t surprise the
